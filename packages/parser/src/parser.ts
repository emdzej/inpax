import { InpaFile, SectionTypeMarkers, GlobalData, UserFunction, Screen, Menu, StateMachine, LogicTable, ConstantData } from "@inpax/core";
import { parseFileHeader } from "./file-header.js";
import { parseSections } from "./sections.js";

export function parseInpaFile(buffer: Buffer): InpaFile {
